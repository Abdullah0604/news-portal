...
const Banner = () => {
  return (
    <div className="bg-slate-100  rounded-md">
      <div className="p-5 lg:p-8 grid grid-cols-1 lg:grid-cols-2 items-center gap-8">
        {/* banner image */}
        <div>
          <Image src={bannerImg} alt="banner image" className="rounded-md" />
        </div>

        {/* banner content */}
        <div className="space-y-3 flex flex-col">
          <h4 className="text-sm font-medium text-gray-400">Technology</h4>
